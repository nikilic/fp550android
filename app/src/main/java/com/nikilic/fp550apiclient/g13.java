...
public class g13 extends AppCompatActivity {
    ...
    public void send(View view){
        ...
        EditText nolinestext = findViewById(R.id.nolines);
        int nolines = Integer.parseInt(nolinestext.getText().toString());
        String url = "https://fp550irvas.localtunnel.me/g13_cmd/"+nolines;
